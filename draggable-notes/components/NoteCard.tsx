    ...
    >
      <div className="flex justify-between items-start mb-3 select-none">
        ...
        <button 
          ...
          className={`absolute top-4 right-4 p-1.5 rounded-full hover:bg-black/10 transition-colors ${isHovered || isDragging ? 'opacity-100' : 'opacity-0 md:opacity-0 opacity-100'}`}
        >
